      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-2xl font-black text-foreground" style={{ fontFamily: 'Space Grotesk' }}>
              {scoreData.awayRuns}
            </p>
          </div>
          ...
          <div className="text-center px-4">
            <div className="rounded-lg bg-primary/10 border border-primary/20 px-3 py-1.5">
              <p className="text-xs font-bold text-primary" style={{ fontFamily: 'Space Grotesk' }}>
                {inningLabel}
              </p>
            </div>
          </div>
