...
interface MapContentProps {
  ...
  heatZones: { center: [number, number]; radius: number; color: string }[];
  clusters: MapCluster[];
  soloFans: MapFan[];
  onTapFan: (fan: MapFan) => void;
}

function MapContent({ allPositions, heatZones, clusters, soloFans, onTapFan }: MapContentProps) {
  return (
    <>
      <TileLayer
