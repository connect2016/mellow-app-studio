...
export function SendToNonUserPanel({ amount, note, onClaimGenerated }: Props) {
  ...
  const handleShareSMS = () => {
    const text = `<ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> ${friendName}, someone bought you a beer on Cubbies Buddies! Claim it here: ${claimUrl}`;
    if (friendPhone) {
  ...
  const handleShareNative = async () => {
    const shareData = {
      title: '<ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> You got a beer!',
    ...
    return (
      ...
      >
        <div className="text-center">
          <p className="text-3xl mb-1"><ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /></p>
        ...
        <p className="text-[10px] text-muted-foreground text-center">
          <ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> When {friendName} taps the link, they'll create a free account and see their beer voucher instantly.
        </p>
      </motion.div>
    );
  }
