  ...
  return (
    <section aria-labelledby="best-vibes-heading" className="mb-5">
      <div className="flex items-baseline justify-between mb-2.5 px-1">
        <h2 id="best-vibes-heading" className="text-base font-extrabold flex items-center gap-1.5 text-foreground">
          <Flame className="h-4 w-4 text-orange-500" /> Best Vibes Tonight
        </h2>
        <Link
          to="/bar-map"
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-base font-bold leading-tight truncate">{v.name}</p>
