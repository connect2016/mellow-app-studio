...
const CARDS: Card[] = [
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(var(--brand-navy)) 0%, #2B5FBF 100%)',
    iconTint: 'hsl(var(--brand-gold))',
  },
  {
    to: '/buddy-heatmap',
    icon: Footprints,
    ...
    gradient: 'linear-gradient(135deg, hsl(var(--brand-red)) 0%, #E85D2A 100%)',
    iconTint: '#FFFFFF',
  },
  {
    to: '/meetups',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #6A1B9A 0%, hsl(var(--brand-red)) 100%)',
    iconTint: 'hsl(var(--brand-gold))',
  },
  {
    to: '/bar-map',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, hsl(var(--brand-navy)) 0%, hsl(var(--brand-gold)) 100%)',
    iconTint: '#FFFFFF',
  },
];
