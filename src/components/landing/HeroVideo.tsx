...
function StrokedTitle({ text, color }: { text: string; color: string }) {
  ...
  return (
    <div style={{ display: 'grid' }}>
      ...
      <div aria-hidden="true" className="hero-title-size" style={{ ...base, color: 'transparent', WebkitTextStroke: '20px hsl(0 0% 0%)', paintOrder: 'stroke fill' }}>{text}</div>
      {/* Layer 2: thick white outline */}
      <div aria-hidden="true" className="hero-title-size" style={{ ...base, color: 'transparent', WebkitTextStroke: '14px hsl(0 0% 100%)', paintOrder: 'stroke fill' }}>{text}</div>
      {/* Layer 3: color fill */}
