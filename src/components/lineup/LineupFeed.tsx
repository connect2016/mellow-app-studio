...
export function LineupFeed() {
  ...
  const handleJoin = async (meetup: LineupMeetup) => {
    ...
    try {
      ...
      toast.success("<ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> You're in! Check the group chat.");
      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          <h3 className="text-base font-bold text-secondary-foreground" style={{ fontFamily: 'Rye, serif' }}>
            <ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> The Lineup
          </h3>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-3 pt-3 border-t border-border/50">
                    {meetup.is_member || isCreator ? (
                      ...
                      >
                        {isFull ? 'Full <ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" />' : "<ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /> I'm In!"}
                      </Button>
                    )}
                  </div>
                </motion.div>
