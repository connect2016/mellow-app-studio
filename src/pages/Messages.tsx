          ...
          <div className="flex-1 space-y-3 p-4 overflow-y-auto">
            {messages.length === 0 && (
              <div className="text-center py-16">
                <p className="text-3xl mb-3"><ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /></p>
              ...
              return (
                ...
                >
                  {profile?.profile_photo ? (
                    ...
                    <div className="h-12 w-12 rounded-full bg-muted flex items-center justify-center text-lg font-bold text-muted-foreground"><ConceptIcon name="" className="inline-block h-[1em] w-[1em] align-[-0.125em]" /></div>
                  )}
