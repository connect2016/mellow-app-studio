            ...
            >
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={item.label} className="flex items-center gap-2.5">
                      <span className="text-lg"><ConceptVisual name={item.emoji} size="sm" /></span>
              ...
              <div className="rounded-2xl border-2 border-dashed border-primary/30 bg-primary/5 p-5">
                ...
                <div className="flex items-center justify-center gap-3">
                  <span className="text-5xl"><ConceptVisual name={POSE_INSTRUCTION.emoji} size="sm" /></span>
          ...
          {step === 'camera' && (
            ...
            >
              <div className="text-center mb-2">
                <p className="text-sm font-semibold text-foreground">Show a <ConceptVisual name={POSE_INSTRUCTION.emoji} size="sm" /> {POSE_INSTRUCTION.label}</p>
              ...
              <div className="relative rounded-2xl overflow-hidden bg-black aspect-square">
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-sm text-white text-xs px-3 py-1.5 rounded-full">
                  <ConceptVisual name={POSE_INSTRUCTION.emoji} size="sm" /> Hold your {POSE_INSTRUCTION.label.toLowerCase()} and tap capture
                </div>
              </div>
