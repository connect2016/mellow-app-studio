...
export const WRIGLEYVILLE_BARS: Bar[] = [
  ...
  { id: '4', name: "Cork Lounge", address: '1822 W Addison St', neighborhood: 'Wrigleyville' },
  { id: '5', name: "Demo Brewing Company", address: '1763 W Berteau Ave', neighborhood: 'Wrigleyville' },
  { id: '6', name: "Dovetail Brewery", address: '1800 W Belle Plaine Ave', neighborhood: 'Wrigleyville' },
  { id: '7', name: "F. O'Mahony's", address: '3701 N Broadway', neighborhood: 'Wrigleyville' },
  { id: '8', name: "Farm Bar Ravenswood", address: '1970 W Montrose Ave', neighborhood: 'Wrigleyville' },
  { id: '9', name: "GMAN Tavern", address: '3740 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '10', name: "Kit Kat Lounge & Supper Club", address: '3524 N Halsted St', neighborhood: 'Wrigleyville' },
  { id: '11', name: "Lucky Dorr", address: '1101 W Waveland Ave', neighborhood: 'Wrigleyville' },
  { id: '12', name: "Martyrs'", address: '3855 N Lincoln Ave', neighborhood: 'Wrigleyville' },
  { id: '13', name: "Metro Chicago", address: '3730 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '14', name: "Moe's Cantina", address: '3518-3522 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '15', name: "Mordecai", address: '3632 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '16', name: "Murphy's Bleachers", address: '3655 N Sheffield Ave', neighborhood: 'Wrigleyville' },
  { id: '17', name: "Smartbar", address: '3730 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '18', name: "The Cubby Bear Lounge Chicago", address: '1059 W Addison St', neighborhood: 'Wrigleyville' },
  { id: '19', name: "The Dugout Sports Bar and Grill", address: '950 W Addison St', neighborhood: 'Wrigleyville' },
  { id: '20', name: "The Long Room", address: '1612 W Irving Park Rd', neighborhood: 'Wrigleyville' },
  { id: '21', name: "The North End", address: '3733 N Halsted St', neighborhood: 'Wrigleyville' },
  { id: '22', name: "The Ravenswood Tavern", address: '1829 W Montrose Ave', neighborhood: 'Wrigleyville' },
  { id: '23', name: "The Sports Corner Bar and Grill", address: '956 W Addison St', neighborhood: 'Wrigleyville' },
  { id: '24', name: "Toons Bar & Grill", address: '3857 N Southport Ave', neighborhood: 'Wrigleyville' },
  { id: '25', name: "Trace", address: '3714 N Clark St', neighborhood: 'Wrigleyville' },
  { id: '26', name: "Wolcott Tap", address: '1834 W Montrose Ave', neighborhood: 'Wrigleyville' },
  { id: '27', name: "Yak-Zie's Bar & Grill", address: '3710 N Clark St', neighborhood: 'Wrigleyville' },
];
